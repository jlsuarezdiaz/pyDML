...
class ITML(DML_Algorithm):
    ...
    def __init__(self,initial_metric = None,upper_bound = None, lower_bound=None, num_constraints = None, gamma = 0.5,tol = 0.001, max_iter = 100000, low_perc=5, up_perc = 95):
